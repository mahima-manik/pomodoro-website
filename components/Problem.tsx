    ...
    <section className="bg-neutral text-neutral-content" id="problem">
      <div className="max-w-7xl mx-auto px-8 py-16 md:py-32 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
          <Step emoji="📝" text="Choose a task you want to focus on" />

          <Arrow extraStyle="max-md:-scale-x-100 md:-rotate-90" />

          <Step emoji="⏲️" text="Work on the task for 25 minutes" />

          <Arrow extraStyle="max-md:-scale-x-100 md:-rotate-90" />

          <Step emoji="☕" text="Take 5 minutes break when the timer rings" />

          <Arrow extraStyle="md:-scale-x-100 md:-rotate-90" />

          <Step emoji="🔁" text="Repeat the process for the next task" />

          <Arrow extraStyle="max-md:-scale-x-100 md:-rotate-90" />

          <Step emoji="🌴" text="After 4 pomodoros, take a longer break (20-30 mins)" />
        </div>
      </div>
    </section>
  );
